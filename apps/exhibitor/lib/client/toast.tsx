...
/**
 * Destructive-but-recoverable actions (deleting a scanned visitor) use a
 * toast-with-undo instead of a blocking confirm() dialog, throughout the
 * app.
 */
    ...
    <ToastContext.Provider value={value}>
      ...
      >
        {toasts.map((toast) => (
          <div
            key={toast.id}
            className="flex w-full max-w-sm items-center justify-between gap-3 rounded-xl border border-border-subtle bg-surface-2 px-4 py-3 shadow-lg"
          >
